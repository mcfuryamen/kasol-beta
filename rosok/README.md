...
- **Versi:** 1.4.9 · **Service Worker:** v70 · **Dexie:** `KasirSoloRosokDB` v5
...
- **Beli Lisensi**: QRIS/rekening live dari Supabase (dikelola aplikasi Control Center), upload bukti → verifikasi admin → aktif otomatis (realtime + polling)
...
**Versi:** 1.4.9 · **Last Updated:** 2026-09-06
