...
const CORE_ASSETS = [
  "./", "./index.html", "./style.css?v=83", "./dexie.min.js",
  "./js/supabase.min.js", "./js/supabase-config.js",
  "./js/app.js?v=83", "./js/confirm.js", "./js/db.js", "./js/app-state.js", "./js/utils.js",
  "./js/version.js", "./js/update.js",
  "./js/router.js", "./js/nav.js", "./js/pos.js", "./js/kategori.js",
  "./js/riwayat.js", "./js/laporan.js", "./js/kas.js",
  "./js/carousel.js", "./js/license.js", "./js/license.sync.js", "./js/onboard.js", "./js/bantuan.js",
...
self.addEventListener("install", e => {
  e.waitUntil(
    caches.open(CACHE_NAME).then(c => {
      // cache:'reload' (paritas kaki5 v187) → precache selalu ambil LANGSUNG
      // dari network (bypass HTTP cache) — cache versi baru tak pernah berisi
      // salinan basi.
      const reqs = CORE_ASSETS.map(u => new Request(u, { cache: 'reload' }));
      return c.addAll(reqs).catch(err => {
  ...
  // TANPA skipWaiting otomatis (paritas kaki5 v187, pemilik 2026-09-15): SW
  // baru masuk status "waiting" dan TIDAK aktif sampai user klik OKE di
  // overlay update (update.js mengirim pesan 'SKIP_WAITING'). skipWaiting
  // otomatis bikin app self-update diam-diam → overlay tak pernah muncul.
});
self.addEventListener("activate", e => {
  e.waitUntil(caches.keys().then(keys => Promise.all(keys.filter(k => k!==CACHE_NAME).map(k => caches.delete(k)))).then(() => self.clients.claim()));
});
// Payload STRING 'SKIP_WAITING' — sama seperti kaki5 & js/update.js.
