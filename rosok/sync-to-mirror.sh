...
#
#  JALANKAN DARI FOLDER PRODUKSI ROSOK:
#     cd C:\Users\Admin\Documents\kasol\rosok
#     bash sync-to-mirror.sh
#
#  Yang dilakukan:
#    1. Menghapus isi lama folder mirror rosok.
...
# Sanity check: folder produksi harus modular
...
# Bersihkan folder mirror rosok lalu buat ulang
echo "▸ Menghapus isi lama folder mirror rosok..."
rm -rf "$MIRROR"
mkdir -p "$MIRROR"
