...
Shop (eks-landing page) pemasaran / funnel calon pelanggan ekosistem **KASIRSOLO** (PT Mesin Kasir Solo).
...
> Shop memegang port ekosistem permanen `8081`. Jangan ganti-ganti port.
...
> Supabase: shop membaca daftar produk via anon key (read-only). Fallback ke
...
- **Vercel git integration** — auto-detect dari folder `shop/`, project `shop`.
