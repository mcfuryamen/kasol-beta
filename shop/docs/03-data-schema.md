...
**Ditulis oleh:** Control Center | **Dibaca oleh:** Shop
...
Array berisi semua pendaftar trial dari form shop.
**Ditulis oleh:** Shop (form submit) | **Dibaca oleh:** Control Center
...
**Ditulis oleh:** Shop (setiap load) | **Dibaca oleh:** Control Center
...
```javascript
// Fungsi helper yang dipakai di shop/index.html
