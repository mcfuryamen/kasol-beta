...
// v29: flip page juga di modul Katalog (form edit) & Konten Web (editor item). Network-first untuk SEMUA aset — versi baru selalu muncul cepat dan
// cache lama tidak pernah menghalangi update (penting untuk env-loader.js
// yang digenerate ulang tiap build).

const CACHE_NAME = 'kasir-control-v29';
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/style.css',
