/**
 * Vercel Serverless Proxy — control/api/rest.js
 * =============================================================================
...
const ALLOWED_REST_TABLES = new Set(['clients', 'products', 'settings', 'site_content', 'outreach_contacts', 'agent_tasks', 'agent_outputs']);
