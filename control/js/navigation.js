...
export function switchScreen(screen, clientView) {
  ...
  // Switch client view — Analitik sudah digabung ke Dashboard, jadi Klien = Kelola.
  // Panggilan LANGSUNG (bukan lewat event) supaya hash awal (#klien-kelola) tetap
  // jalan saat bootstrap; render dobel dicegah oleh guard same-view di switchClientView.
  if (screen === 'klien') {
    window.switchClientView(clientView || 'kelola');
  }
