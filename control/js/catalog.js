    ...
    <div class="field-grid">
      ...
      <div class="field">
        ...
        <input type="number" id="catOrderIndex" value="${app.orderIndex || 0}" min="0" step="1">
            ...
            <div class="field field-span-2">
              <label class="field-label">🎬 Video Tutorial (YouTube)</label>
              ...
              <small class="field-hint">Satu video per baris: <b>Judul | URL | Durasi | Deskripsi</b> (URL boleh link watch/shorts/youtu.be/embed atau tempel kode &lt;iframe&gt; utuh; tanpa "|" dianggap URL polos). Hanya YouTube yang render di aplikasi; lainnya dilewati. Muncul di tab 🎬 Video halaman Bantuan aplikasi ini.</small>
            </div>
          </div>
      </div>
