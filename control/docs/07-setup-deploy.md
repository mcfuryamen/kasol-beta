# Control Center — Setup & Deploy

Panduan lengkap development dan deployment Control Center (modular ESM, Vercel deployment).
...
.\push-beta.ps1
#    → sync control/ ke mirror kasol-beta → squash 1 commit → push GitHub BETA main
...
*Setup & Deploy — KASIRSOLO Control Center*
