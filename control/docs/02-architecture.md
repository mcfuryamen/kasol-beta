...
│   │  kasirsolo:settings   ◄── tulis ──┤  Control Center           │       │
...
Lisensi terintegrasi langsung di tab **Lisensi** pada Control Center.
...
> `control/` & app klien sinkron ke Supabase. **Arah target:** keduanya via Supabase,
...
> Migrasi ini mencakup **Lapisan A (Meta/CRM)** — data control/CRM. **Data Bisnis**
...
*Architecture Control Center — KASIRSOLO*