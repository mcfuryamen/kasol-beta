...
### 1. Control Center (C:\Users\Admin\Documents\kasol\admin)
...
| File | Aksi |
|------|------|
| `control/index.html` | +Tab Pembelian |
| `control/js/clients.js` | +loadPembelianList, renderPembelianList, verifyPembelian, activatePembelian |
| `control/js/pembelian.js` | **BARU** - Module pembelian |
| `control/js/app.js` | +import pembelian |
