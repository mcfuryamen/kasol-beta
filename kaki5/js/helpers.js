// ==================== HELPERS (ESM) ====================
// UI helpers. Fungsi murni (escapeHtml, buildSafeHtml, dll.) didelegasikan ke
// helpers.pure.js — konsumen `import ... from './helpers.js'` mendapatkannya
// via `export * from` di bawah (SATU definisi, tidak duplikasi, audit 2026-09-17).
...
// (2026-09-17) duplikasi lokal escapeHtml/buildSafeHtml DIHAPUS — star-export
// di bawah jadi satu-satunya definisi; konsumen helpers.js tetap mendapatkannya.
