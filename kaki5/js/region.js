...
export function setupRegionPicker({ provSel, kabSel, kecSel, desaSel, state }) {
  ...
  async function loadKab(provId, selectKab) {
    try {
      ...
      // Audit toast 2026-09-07: inline "tidak tersedia" tidak menjelaskan
      // penyebab (offline) & tanpa petunjuk retry.
      showToast('⚠️ Daftar wilayah gagal dimuat — cek internet lalu pilih ulang', 'warning', 4000);
    }
  }
