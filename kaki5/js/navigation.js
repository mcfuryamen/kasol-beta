...
export async function navigateTo(page) {
  ...
  // Hard gate (lockOverlay, updateOverlay) dikecualikan di dalam
  // closeAllModals() lewat HARD_GATE_OVERLAYS. bukaKasModal sejak v180 bukan
  // hard gate lagi — gerbang kas hanya ditegakkan di Jualan oleh kas.js.
