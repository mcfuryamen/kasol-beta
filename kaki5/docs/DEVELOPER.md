...
Versi acuan: **v208 / 1.0.133 (2026-09-17)**. Setiap klaim disertai `file:baris`.
...
<script type="module" src="js/app.js?v=208"></script>  <!-- :1038 entry -->
...
```
                    ...
                    └───────────────┬──────────────────────────┘
                                    │ dexie.min.js (global) → app.js?v=208 (ESM)
                    ┌───────────────▼──────────────────────────┐
                    │  app.js  — entry                          │
...
*Terakhir diselaraskan dengan kode: **v208 / 1.0.133, 2026-09-17**.*
