...
|---|---|---|
| 1 | `js/version.js` → `APP_VERSION` (`:7`) | `1.0.119` |
| 2 | `js/version.js` → `CACHE_BUST` (`:18`) | `v194` |
| 3 | `js/version.json` → `"version"` (`:2`) | `1.0.119` |
| 4 | `js/version.json` → `"cacheBust"` (`:3`) | `v194` |
| 5 | `sw.js` → `CACHE_NAME` (`:201`) **dan** komentar "Cache version vNNN" (`:4`) + blok catatan rilis (`:7-191`) | `kasir-solo-kaki5-v194` |
| 6 | `index.html` → `js/app.js?v=` (`:1014`) | `?v=184` |
