    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div class="w-full max-w-sm">
        ...
        {import.meta.env.VITE_DEMO_MODE === 'true' && (
          <button
            type="button"
            onClick={() => onSubmit('admin@tpa.demo', 'demo')}
            class="w-full mt-3 px-4 py-2 text-sm text-orange-600 font-semibold hover:bg-orange-50 rounded-lg border border-orange-200 transition-colors"
          >
            MASUK DEMO MODE
          </button>
        )}
