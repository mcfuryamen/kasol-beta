  ...
  return (
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-lg font-bold text-gray-800">Progres Hafalan</h2>
          <p class="text-sm text-gray-500">Lihat progres hafalan semua santri</p>
        </div>
      ...
      <Card>
        <div class="text-center py-12 text-gray-400">
          ...
          <p class="text-lg font-medium">Modul Progres Hafalan</p>
