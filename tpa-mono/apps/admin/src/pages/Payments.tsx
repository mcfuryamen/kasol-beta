  ...
  return (
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-lg font-bold text-gray-800">Pembayaran SPP</h2>
          <p class="text-sm text-gray-500">Kelola tagihan dan pembayaran SPP</p>
        </div>
      ...
      <Card>
        <div class="text-center py-12 text-gray-400">
          ...
          <p class="text-lg font-medium">Modul Pembayaran SPP</p>
