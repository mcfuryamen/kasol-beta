  ...
  return (
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-lg font-bold text-gray-800">Laporan</h2>
          <p class="text-sm text-gray-500">Laporan keuangan, absensi, dan progres</p>
        </div>
      ...
      <Card>
        <div class="text-center py-12 text-gray-400">
          ...
          <p class="text-lg font-medium">Modul Laporan</p>
